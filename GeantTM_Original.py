...
class GEANTopo(Topo):
    ...
    def __init__(self):
        ...
        self.addLink( switch_10 , switch_3, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_22 , switch_20, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_15 , switch_20, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_3 , switch_14, bw=1.55, delay='1ms')#, loss=1)
        self.addLink( switch_7 , switch_19, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_10 , switch_11, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_5 , switch_8, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_7 , switch_17, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_3 , switch_11, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_13 , switch_19, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_8 , switch_9, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_3 , switch_21, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_14 , switch_13, bw=1.55, delay='1ms')#, loss=1)
        self.addLink( switch_2 , switch_13, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_6 , switch_19, bw=1.55, delay='1ms')#, loss=1)
        self.addLink( switch_12 , switch_22, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_16 , switch_10, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_1 , switch_7, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_3 , switch_1, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_2 , switch_4, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_17 , switch_13, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_1 , switch_16, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_9 , switch_15, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_20 , switch_17, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_2 , switch_18, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_17 , switch_10, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_6 , switch_7, bw=1.55, delay='1ms')#, loss=1)
        self.addLink( switch_16 , switch_5, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_4 , switch_16, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_2 , switch_23, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_7 , switch_21, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_12 , switch_10, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_7 , switch_2, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_17 , switch_23, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_21 , switch_18, bw=25.0, delay='1ms')#, loss=1)
        self.addLink( switch_16 , switch_9, bw=100.0, delay='1ms')#, loss=1)
        self.addLink( switch_2 , switch_12, bw=100.0, delay='1ms')#, loss=1)
...
def launch(controllerIp, controllerPort, trafficFlag_iperf, trafficFlag_ditg, ping, ac, tm):
   ...
   # set_OFP_protocol(net.switches)
    ...
    if trafficFlag_iperf == "yes": 
        ...
        call_bot("*** Generating traffic from TMs ***")
...
def trafficGen_iperf (hosts_,tm):
    ...
    for tm in range(int(tms[0]),int(tms[1])): #While testing with just one TM
...
# def trafficGen_iperf (hosts_):#antes de hacer toras topologias
#     '''
#     Launch servers with specific port per host and generate UDP traffic with iperf3 according to the 
#     Geant 2004 traffic matrixes 
#     '''
...
#     # for tm in range(num_folders): #traffic by reading all the TMs
#     for tm in range(1): #While testing with just one TM
#         print('***'+foldersNames[tm]+'***')
#         call_bot('***'+foldersNames[tm]+'***')
#         print( "*** 1. Launching servers ***" )
#         call_bot("*** 1. Launching servers ***")
...
if __name__ == '__main__':
    ...
    if (error == False):
        ...
        launch(controllerIp=controllerIp, controllerPort=controllerPort, trafficFlag_iperf=trafficFlag_iperf, trafficFlag_ditg=trafficFlag_ditg, ping=ping, ac=ac, tm=tm)
